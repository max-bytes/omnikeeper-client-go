...
// checks if the AbstractInboundIDMethod type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AbstractInboundIDMethod{}
...
type _AbstractInboundIDMethod AbstractInboundIDMethod
...
func (o *AbstractInboundIDMethod) UnmarshalJSON(bytes []byte) (err error) {
	...
	varAbstractInboundIDMethod := _AbstractInboundIDMethod{}

	err = json.Unmarshal(bytes, &varAbstractInboundIDMethod)

	if err != nil {
		return err
	}

	*o = AbstractInboundIDMethod(varAbstractInboundIDMethod)
